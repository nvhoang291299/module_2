...
public class VillaService implements IVillaService {
    ...
    public void addService() {
        ...
        while(areaSwimming < 30.0){
            try {
                System.out.println("nhập lại diện tích sử dụng:");
                areaSwimming = Float.parseFloat(sc.nextLine());
                throw new UserException("giá trị bạn nhập vào lớn hơn 30");
            } catch (UserException e){
                System.out.println(e.getMessage());
            } catch (NumberFormatException e){
        ...
        Villa villa = new Villa(nameService, area, cost, amount, rental, roomStandard, areaSwimming, floors, codeService);
